...
function LoginForm() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-navy-950 px-4">
      <div className="w-full max-w-sm">
        {/* Logo */}
        <div className="flex items-center justify-center space-x-3 mb-8">
          <div className="p-2 bg-navy-800 rounded-lg shadow-card">
        ...
        <div className="bg-navy-900 border border-white/10 rounded-2xl p-8 shadow-card-hover space-y-6">
          <div className="text-center space-y-1">
            <h1 className="text-lg font-bold text-white">Sign in to your account</h1>
            <p className="text-xs text-navy-200">Access your properties, reports, and recommendations.</p>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <span className="text-[10px] font-bold uppercase tracking-widest text-navy-300">or</span>
            <div className="flex-1 h-px bg-white/10" />
          </div>

          <form onSubmit={handleCredentialsSubmit} className="space-y-4">
            <div className="space-y-1.5">
              <label htmlFor="email" className="block text-xs font-semibold text-navy-200">
                Email
              </label>
              <input
                id="email"
                ...
                className="w-full text-sm bg-white/5 border border-white/10 rounded-xl px-3 py-2.5 text-white placeholder:text-navy-300 focus:outline-none focus:border-accent-500 transition-colors"
                placeholder="you@company.com"
              />
            </div>
            <div className="space-y-1.5">
              <label htmlFor="password" className="block text-xs font-semibold text-navy-200">
                Password
              </label>
              <input
                id="password"
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full bg-accent-500 hover:bg-accent-600 disabled:opacity-60 disabled:cursor-not-allowed text-white text-sm font-bold py-2.5 rounded-xl transition-colors shadow-card"
            >
